...
class XLSXViewer(QWidget):
    ...
    def __init__(self, input_file) -> None:
        ...
        self.log.info("Initializing XLSXViewer...")
    ...
    def load_file(self, filename):
        df = pd.read_excel(filename)   # lit le fichier xlsx
        html = df.to_html(index=False) # convertit en html
        self.webView.setHtml(html)     # affiche le html dans le viewer
